...
namespace _06_RepositoryPattern_Tests
{
    ...
    public class StreamingContentRepositoryTests
    {
        ...
        public void UpdateExistingContent_ShouldReturnTrue()
        {
            ...
            //TestInitialize
            StreamingContent newContent = new StreamingContent("Rubber", "A car tire comes to life with the power to make people explode and goes on a murderous rampage through the Californian desert.", "R", 5.8, false, GenreType.RomCom);
